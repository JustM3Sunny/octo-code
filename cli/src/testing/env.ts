import { createTestBaseEnv } from '@siya/common/testing-env-process'
...
export const createTestCliEnv = (overrides: Partial<CliEnv> = {}): CliEnv => ({
  ...
  VISUAL: undefined,
  EDITOR: undefined,
  SIYA_CLI_EDITOR: undefined,
  SIYA_EDITOR: undefined,
  OPEN_TUI_THEME: undefined,
  OPENTUI_THEME: undefined,
  SIYA_IS_BINARY: undefined,
  SIYA_CLI_VERSION: undefined,
  SIYA_CLI_TARGET: undefined,
  SIYA_RG_PATH: undefined,
  Siya_SCROLL_MULTIPLIER: undefined,
  ...overrides,
})
