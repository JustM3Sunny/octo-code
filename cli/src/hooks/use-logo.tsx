...
import { LOGO, LOGO_SMALL, SHADOW_CHARS, parseLogoLines } from '../utils/branding'
 ...
 * - Text variant "Siya" or "Siya CLI" for narrow widths
 *
...
export const useLogo = ({
  ...
  const component = useMemo(() => {
    ...
    if (rawLogoString === 'SIYA') {
      ...
      const displayText =
        availableWidth < 30 || forcedByHeight ? 'Siya' : 'Siya CLI'
