...
} from '@siya/common/analytics-core'
import {
  env as defaultEnv,
  IS_PROD as defaultIsProd,
  DEBUG_ANALYTICS,
} from '@siya/common/env'
import { shouldTrackAnalyticsEvent } from '@siya/common/util/analytics-sampling'

import type { AnalyticsEvent } from '@siya/common/constants/analytics-events'


// Re-export types from core for backwards compatibility
export type { AnalyticsClientWithIdentify as AnalyticsClient } from '@siya/common/analytics-core'
