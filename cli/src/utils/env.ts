...
export const getCliEnv = (): CliEnv => ({
  ...
  SIYA_CLI_EDITOR: process.env.SIYA_CLI_EDITOR,
  SIYA_EDITOR: process.env.SIYA_EDITOR,
  ...
  SIYA_IS_BINARY: process.env.SIYA_IS_BINARY,
  SIYA_CLI_VERSION: process.env.SIYA_CLI_VERSION,
  SIYA_CLI_TARGET: process.env.SIYA_CLI_TARGET,
  SIYA_RG_PATH: process.env.SIYA_RG_PATH,
  Siya_SCROLL_MULTIPLIER: process.env.Siya_SCROLL_MULTIPLIER,
  Siya_PERF_TEST: process.env.Siya_PERF_TEST,
  Siya_TRACE: process.env.Siya_TRACE,
})
