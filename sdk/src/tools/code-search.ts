...
import { Logger } from '@siya/common/types/contracts/logger'
...
export function codeSearch({
  ...
  return new Promise((resolve) => {
    ...
    childProcess.once('error', (error) => {
      if (isResolved) return
      settle({
        errorMessage: `Failed to execute ripgrep: ${error.message}. Vendored ripgrep not found; ensure @siya/sdk is up-to-date or set Siya_RG_PATH.`,
      })
    })
  })
}
