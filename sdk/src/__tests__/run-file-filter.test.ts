import * as mainPromptModule from '@siya/agent-runtime/main-prompt'
import { FILE_READ_STATUS } from '@siya/common/old-constants'
import * as projectFileTree from '@siya/common/project-file-tree'
import { getInitialSessionState } from '@siya/common/types/session-state'
import { getStubProjectFileContext } from '@siya/common/util/file'
import { afterEach, describe, expect, it, mock, spyOn } from 'bun:test'

import { SiyaClient } from '../client'
...
function createMockFs(config: {
  ...
  } as unknown as SiyaFileSystem
}

describe('SiyaClientOptions fileFilter', () => {
  afterEach(() => {
    mock.restore()
  })
