// Build script for @siya/sdk using Bun's bundler with dual package support
...
async function build() {
  ...
  const external = [
    ...
    ...Object.keys(pkg.dependencies || {}).filter(
      (dep) => !dep.startsWith('@siya/') && !dep.startsWith('@siya/'),
    ),
      ...
      [
        {
          ...
          libraries: {
            // Treat all @siya/* workspace packages as external imports
