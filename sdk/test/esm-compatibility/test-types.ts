...
import * as FullSDK from '@siya/sdk'
;
...
(async () => {
  ...
  const dynamicSDK = await import('@siya/sdk')
  const ClientFromDynamic: typeof ClientClass = dynamicSDK.SiyaClient
  console.log('✅ Dynamic imports work in TypeScript ESM')

  // Test 6: Namespace imports work
  const ClientFromNamespace: typeof ClientClass = FullSDK.SiyaClient
