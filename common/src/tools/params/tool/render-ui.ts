...
const inputSchema = z
  ...
  .describe(
    'Render a small interactive UI widget in the Siya CLI. Currently supports a button that opens a link.',
  )
...
const description = `
Render a small interactive UI widget in the Siya CLI.
