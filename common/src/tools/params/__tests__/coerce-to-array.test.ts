...
describe('normalizeReplacementAliases', () => {
  ...
  it('maps model typos like newala onto newString', () => {
    expect(
      normalizeReplacementAliases({
        oldString: 'before',
        newala: 'after',
  ...
  it('defaults missing newString to empty string when oldString is present', () => {
    expect(
      normalizeReplacementAliases({
        oldString: 'delete me',
      }),
  ...
  it('parses stringified replacement objects', () => {
    expect(
      normalizeReplacementAliases(
...
describe('normalizeStrReplaceInput', () => {
  it('wraps flat oldString/newString at the root into replacements', () => {
    expect(
      normalizeStrReplaceInput({
        path: 'file.ts',
        oldString: 'before',
  ...
  it('accepts singular replacement key', () => {
    expect(
      normalizeStrReplaceInput({
        path: 'file.ts',
        replacement: [{ oldString: 'before', newString: 'after' }],
      }),
    ).toEqual({
      path: 'file.ts',
      replacements: [{ oldString: 'before', newString: 'after' }],
