...
const ORIGINAL_ENV = {
  Siya_FULL_TELEMETRY: process.env.Siya_FULL_TELEMETRY,
  Siya_FULL_TELEMETRY_IDS: process.env.Siya_FULL_TELEMETRY_IDS,
  Siya_FULL_TELEMETRY_USER_IDS:
    process.env.Siya_FULL_TELEMETRY_USER_IDS,
}
...
describe('analytics sampling', () => {
  ...
  it('honors full telemetry env flags and allowlists', () => {
    process.env.Siya_FULL_TELEMETRY = 'true'
    expect(
      isFullTelemetryEnabled({
        distinctId: 'anyone',
      }),
    ...
    delete process.env.Siya_FULL_TELEMETRY
    process.env.Siya_FULL_TELEMETRY_IDS = 'user-2,person@example.com'
