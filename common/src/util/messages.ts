...
import type {
  ...
  ToolMessage,
  UserMessage,
} from '../types/messages/siya-message'
...
>(obj: T): T {
  ...
  /* 'Siya' provider name is not compatible with providerMetadata for
...
function assistantToSiyaMessage(
