...
const runtimeAttributionFields = {
  external_session_id: z
    ...
    .optional()
    .describe(
      'Stable Siya session ID for Gravity API key attribution. Siya usually fills this automatically.',
    ),
  metadata: jsonObjectSchema
    .optional()
    .describe(
      'Non-sensitive API key metadata for Gravity attribution and debugging. Siya usually fills this automatically.',
    ),
}
