...
/**
 * Extended CI env with Siya-specific CI vars.
 * Used by agent-runtime and server code.
 */
export type CiEnv = BaseCiEnv & {
  SIYA_GITHUB_TOKEN?: string
...
export type ProcessEnv = BaseEnv & {
  ...
  // Siya CLI-specific (set during binary build)
  SIYA_IS_BINARY?: string
  SIYA_CLI_VERSION?: string
  SIYA_CLI_TARGET?: string
  SIYA_RG_PATH?: string
  SIYA_WASM_DIR?: string
