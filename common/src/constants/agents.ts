...
export const AGENT_PERSONAS = {
  // Base agents - all use Siya persona
  base: {
    displayName: 'Siya the Base Agent',
  ...
  'agent-builder': {
    ...
    purpose: 'Creates new agent templates for the Siya multi-agent system',
    hidden: false,
  } as const,
...
export const AGENT_ID_PREFIX = 'SiyaAI/'
