import { trackEvent } from '@siya/common/analytics'
import { AnalyticsEvent } from '@siya/common/constants/analytics-events'
import { AgentTemplateTypes } from '@siya/common/types/session-state'
...
import type { ClientAction } from '@siya/common/actions'
import type { CostMode } from '@siya/common/old-constants'
import type {
  RequestToolCallFn,
  SendActionFn,
