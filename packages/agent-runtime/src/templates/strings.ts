import { KNOWLEDGE_FILE_NAMES_LOWERCASE } from '@siya/common/constants/knowledge'
import { escapeString } from '@siya/common/util/string'
...
export async function formatPrompt(
  ...
  const toInject: Record<PlaceholderValue, () => string | Promise<string>> = {
    [PLACEHOLDER.AGENT_NAME]: () =>
      agentTemplate ? agentTemplate.displayName || 'Unknown Agent' : 'Siya',
