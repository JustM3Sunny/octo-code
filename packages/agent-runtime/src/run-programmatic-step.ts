import { HandleStepsYieldValueSchema } from '@siya/common/types/agent-template'
...
import type {
  ...
  SendActionFn,
} from '@siya/common/types/contracts/client'
import type { AddAgentStepFn } from '@siya/common/types/contracts/database'
