import * as analytics from '@siya/common/analytics'
import { TEST_USER_ID } from '@siya/common/old-constants'
import { createTestAgentRuntimeParams } from '@siya/common/testing/fixtures/agent-runtime'
import { clearMockedModules } from '@siya/common/testing/mock-modules'
import {
  createMockDbOperations,
  setupDbSpies,
} from '@siya/common/testing/mocks/database'
import { getInitialSessionState } from '@siya/common/types/session-state'
import { AbortError, promptSuccess } from '@siya/common/util/error'
...
import type { DbSpies } from '@siya/common/testing/mocks/database'
import type { StepGenerator } from '@siya/common/types/agent-template'
    ...
    it('should propagate error code and server message from 403 APICallError responseBody', async () => {
      ...
      loopAgentStepsBaseParams.promptAiSdkStream = async function* () {
        throw new APICallError({
          statusCode: 403,
          message: 'Forbidden',
          url: 'https://api.Siya.com/v1/chat/completions',
          requestBodyValues: {},
