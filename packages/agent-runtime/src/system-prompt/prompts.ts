...
import { createMarkdownFileBlock } from '@siya/common/util/file'
import { truncateString } from '@siya/common/util/string'
import { closeXml } from '@siya/common/util/xml'
...
4. Use the 'write_file' tool to save this Markdown summary to a new file with a generated name starting with the prefix 'Siya-export-' like 'Siya-export-topic-of-conversation.md' in the project root directory.

Write file tool format:

<write_file>
<path>Siya-export-file-name.md${closeXml('path')}
<content>
...
As Siya, you have access to all the files in the project.
