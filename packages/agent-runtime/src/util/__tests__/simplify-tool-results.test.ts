...
describe('simplifyReadFileResults', () => {
  it('should simplify read file results by omitting content', () => {
    const input: SiyaToolOutput<'read_files'> = [
      {
        type: 'json',
        value: [
          {
  ...
  it('should not mutate the original input', () => {
    const originalInput: SiyaToolOutput<'read_files'> = [
      {
        type: 'json',
        value: [
          {
...
describe('simplifyTerminalCommandResults', () => {
  it('should simplify terminal command results with stdout', () => {
    const input: SiyaToolOutput<'run_terminal_command'> = [
      {
        type: 'json',
        value: {
          command: 'npm test',
  ...
  it('should not mutate the original input', () => {
    const originalInput: SiyaToolOutput<'run_terminal_command'> = [
      {
        type: 'json',
        value: {
          command: 'npm test',
