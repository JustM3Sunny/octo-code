import {
  ...
  endToolTag,
  toolNameParam,
} from '@siya/common/tools/constants'
...
/**
 * Parses text containing tool calls in the <Siya_tool_call> XML format,
...
export function parseTextWithToolCalls(text: string): ParsedSegment[] {
  ...
  // Match <Siya_tool_call>...</Siya_tool_call> blocks
...
/**
 * Parses tool calls from text in the <Siya_tool_call> XML format.
