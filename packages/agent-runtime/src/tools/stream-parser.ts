...
import { AbortError } from '@siya/common/util/error'
import {
  assistantMessage,
  userMessage,
...
export async function processStream(
  ...
  const toolCalls: (SiyaToolCall | CustomToolCall)[] = []
  const toolCallsToAddToMessageHistory: (SiyaToolCall | CustomToolCall)[] = []
