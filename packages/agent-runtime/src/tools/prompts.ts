import { endsAgentStepParam } from '@siya/common/tools/constants'
import { toolParams } from '@siya/common/tools/list'
import { AVAILABLE_SKILLS_PLACEHOLDER } from '@siya/common/tools/params/tool/skill'
import { getToolCallString } from '@siya/common/tools/utils'
import { buildArray } from '@siya/common/util/array'
import { formatAvailableSkillsXml } from '@siya/common/util/skills'
...
You (Siya) have access to the following tools. Call them when needed.
