...
import { removeUndefinedProps } from '@siya/common/util/object'
...
export const handleLookupAgentInfo = (async (params: {
  toolCall: SiyaToolCall<'lookup_agent_info'>
...
}): Promise<{ output: SiyaToolOutput<'lookup_agent_info'> }> => {
...
}) satisfies SiyaToolHandlerFunction<'lookup_agent_info'>
