...
export const handleWriteFile = (async (
  params: {
    ...
    toolCall: SiyaToolCall<'write_file'>
    ...
    ) => Promise<SiyaToolOutput<'write_file'>>
    requestOptionalFile: RequestOptionalFileFn
    writeToClient: (chunk: string) => void
  } & ParamsExcluding<RequestOptionalFileFn, 'filePath'>,
): Promise<{ output: SiyaToolOutput<'write_file'> }> => {
  const {
...
}) satisfies SiyaToolHandlerFunction<'write_file'>
