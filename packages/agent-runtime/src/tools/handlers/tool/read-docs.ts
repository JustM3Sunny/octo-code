...
import { callDocsSearchAPI } from '../../../llm-api/siya-web-api'
...
export const handleReadDocs = (async (
  params: {
    ...
    toolCall: SiyaToolCall<'read_docs'>
  ...
  output: SiyaToolOutput<'read_docs'>
  creditsUsed: number
}> => {
  const {
...
}) satisfies SiyaToolHandlerFunction<'read_docs'>
